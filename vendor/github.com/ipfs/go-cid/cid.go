...
const (
	...
	VntTxTrie          = 0x92
	VntTx              = 0x93
	VntTxReceiptTrie   = 0x94
	VntTxReceipt       = 0x95
	VntStateTrie       = 0x96
	VntAccountSnapshot = 0x97
	VntStorageTrie     = 0x98
	BitcoinBlock       = 0xb0
	BitcoinTx          = 0xb1
	ZcashBlock         = 0xc0
...
var Codecs = map[string]uint64{
	...
	"git-raw":              GitRaw,
	"vnt-block":            VntBlock,
	"vnt-block-list":       VntBlockList,
	"vnt-tx-trie":          VntTxTrie,
	"vnt-tx":               VntTx,
	"vnt-tx-receipt-trie":  VntTxReceiptTrie,
	"vnt-tx-receipt":       VntTxReceipt,
	"vnt-state-trie":       VntStateTrie,
	"vnt-account-snapshot": VntAccountSnapshot,
	"vnt-storage-trie":     VntStorageTrie,
...
var CodecToStr = map[uint64]string{
	...
	GitRaw:             "git-raw",
	VntBlock:           "vnt-block",
	VntBlockList:       "vnt-block-list",
	VntTxTrie:          "vnt-tx-trie",
	VntTx:              "vnt-tx",
	VntTxReceiptTrie:   "vnt-tx-receipt-trie",
	VntTxReceipt:       "vnt-tx-receipt",
	VntStateTrie:       "vnt-state-trie",
	VntAccountSnapshot: "vnt-account-snapshot",
	VntStorageTrie:     "vnt-storage-trie",
