...
# 1. install gvnt for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gvnt
# 5. create gvnt, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable HUBBLE_SOCKET
...
!define GROUPNAME "VNT"
!define APPNAME "Gvnt"
!define DESCRIPTION "Official Go implementation of the VNT protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gvnt is installed global
