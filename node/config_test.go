...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gvnt.ipc", false, filepath.Join(os.TempDir(), "gvnt.ipc")},
		{"data", "gvnt.ipc", false, "data/gvnt.ipc"},
		{"data", "./gvnt.ipc", false, "./gvnt.ipc"},
		{"data", "/gvnt.ipc", false, "/gvnt.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gvnt.ipc", true, `\\.\pipe\gvnt.ipc`},
		{"data", "gvnt.ipc", true, `\\.\pipe\gvnt.ipc`},
		{"data", `\\.\pipe\gvnt.ipc`, true, `\\.\pipe\gvnt.ipc`},
	}
