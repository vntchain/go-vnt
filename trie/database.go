...
type Database struct {
	diskdb vntdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb vntdb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch vntdb.Batch) error {
