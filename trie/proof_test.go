...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *vntdb.MemDatabase {
	var provers []func(key []byte) *vntdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *vntdb.MemDatabase {
		proof := vntdb.NewMemDatabase()
