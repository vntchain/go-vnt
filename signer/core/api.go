...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*vntapi.SignTransactionResult, error)
...
type SignerUI interface {
	...
	OnApprovedTx(tx vntapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*vntapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := vntapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
