...
const (
	...
	MessageType_MessageType_VntGetAddress        MessageType = 56
	MessageType_MessageType_VntAddress           MessageType = 57
	MessageType_MessageType_VntSignTx            MessageType = 58
	MessageType_MessageType_VntTxRequest         MessageType = 59
	MessageType_MessageType_VntTxAck             MessageType = 60
	...
	MessageType_MessageType_VntSignMessage       MessageType = 64
	MessageType_MessageType_VntVerifyMessage     MessageType = 65
	MessageType_MessageType_VntMessageSignature  MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_VntGetAddress",
	57:  "MessageType_VntAddress",
	58:  "MessageType_VntSignTx",
	59:  "MessageType_VntTxRequest",
	60:  "MessageType_VntTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_VntSignMessage",
	65:  "MessageType_VntVerifyMessage",
	66:  "MessageType_VntMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_VntGetAddress":        56,
	"MessageType_VntAddress":           57,
	"MessageType_VntSignTx":            58,
	"MessageType_VntTxRequest":         59,
	"MessageType_VntTxAck":             60,
	"MessageType_GetECDHSessionKey":    61,
	"MessageType_ECDHSessionKey":       62,
	"MessageType_SetU2FCounter":        63,
	"MessageType_VntSignMessage":       64,
	"MessageType_VntVerifyMessage":     65,
	"MessageType_VntMessageSignature":  66,
...
// *
// Request: Ask device for VNT address corresponding to address_n path
// @next PassphraseRequest
// @next VntAddress
// @next Failure
type VntGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *VntGetAddress) Reset()                    { *m = VntGetAddress{} }
func (m *VntGetAddress) String() string            { return proto.CompactTextString(m) }
func (*VntGetAddress) ProtoMessage()               {}
func (*VntGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *VntGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *VntGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an VNT address derived from device private seed
// @prev VntGetAddress
type VntAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *VntAddress) Reset()                    { *m = VntAddress{} }
func (m *VntAddress) String() string            { return proto.CompactTextString(m) }
func (*VntAddress) ProtoMessage()               {}
func (*VntAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *VntAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *VntSignTx) Reset()                    { *m = VntSignTx{} }
func (m *VntSignTx) String() string            { return proto.CompactTextString(m) }
func (*VntSignTx) ProtoMessage()               {}
func (*VntSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *VntSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *VntSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *VntSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *VntSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *VntSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *VntSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *VntSignTx) GetDataLength() uint32 {
...
func (m *VntSignTx) GetChainId() uint32 {
...
func (m *VntTxRequest) Reset()                    { *m = VntTxRequest{} }
func (m *VntTxRequest) String() string            { return proto.CompactTextString(m) }
func (*VntTxRequest) ProtoMessage()               {}
func (*VntTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *VntTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *VntTxRequest) GetSignatureV() uint32 {
...
func (m *VntTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *VntTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev VntTxRequest
// @next VntTxRequest
type VntTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *VntTxAck) Reset()                    { *m = VntTxAck{} }
func (m *VntTxAck) String() string            { return proto.CompactTextString(m) }
func (*VntTxAck) ProtoMessage()               {}
func (*VntTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *VntTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next VntMessageSignature
// @next Failure
type VntSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *VntSignMessage) Reset()                    { *m = VntSignMessage{} }
func (m *VntSignMessage) String() string            { return proto.CompactTextString(m) }
func (*VntSignMessage) ProtoMessage()               {}
func (*VntSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *VntSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *VntSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
func (m *VntVerifyMessage) Reset()                    { *m = VntVerifyMessage{} }
func (m *VntVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*VntVerifyMessage) ProtoMessage()               {}
func (*VntVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *VntVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *VntVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *VntVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// Response: Signed message
// @prev VntSignMessage
type VntMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *VntMessageSignature) Reset()                    { *m = VntMessageSignature{} }
func (m *VntMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*VntMessageSignature) ProtoMessage()               {}
func (*VntMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *VntMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *VntMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*VntGetAddress)(nil), "VntGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*VntAddress)(nil), "VntAddress")
	...
	proto.RegisterType((*VntSignTx)(nil), "VntSignTx")
	proto.RegisterType((*VntTxRequest)(nil), "VntTxRequest")
	proto.RegisterType((*VntTxAck)(nil), "VntTxAck")
	proto.RegisterType((*VntSignMessage)(nil), "VntSignMessage")
	proto.RegisterType((*VntVerifyMessage)(nil), "VntVerifyMessage")
	proto.RegisterType((*VntMessageSignature)(nil), "VntMessageSignature")
