...
func (sc *Client) MarkTrustedPeer(ctx context.Context, vnode string) error {
	var ignored bool
	return sc.c.CallContext(ctx, &ignored, "shh_markTrustedPeer", vnode)
}
...
func (sc *Client) SubscribeMessages(ctx context.Context, criteria whisper.Criteria, ch chan<- *whisper.Message) (hubble.Subscription, error) {
