...
import (
	...
	gvntmetrics "github.com/vntchain/go-vnt/metrics"
...
func Setup(ctx *cli.Context) {
	if gvntmetrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(gvntmetrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
