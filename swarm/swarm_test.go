...
func TestParseVnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/gvnt.ipc",
			endpoint:    "/data/testnet/gvnt.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/gvnt.ipc",
			endpoint:    "/data/testnet/gvnt.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gvnt.ipc",
			endpoint:    "/data/testnet/gvnt.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gvnt.ipc",
			endpoint:    "/data/testnet/gvnt.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
