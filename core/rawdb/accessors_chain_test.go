...
func TestBodyStorage(t *testing.T) {
	...
	body := &types.Body{Transactions: []*types.Transaction{types.NewTransaction(1,
		common.HexToAddress("0x0000000000000000000000000000000000000000"), common.Big1,
		123456, common.Big2, []byte("test tx"))}}
