...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(vntdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db vntdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db vntdb.Database, root common.Hash) error {
...
func checkStateConsistency(db vntdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, vntdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(vntdb.Database), srcRoot)
