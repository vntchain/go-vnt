...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := vntdb.NewMemDatabase()
	finalDb := vntdb.NewMemDatabase()
...
// https://github.com/vntchain/go-vnt/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(vntdb.NewMemDatabase()))
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(vntdb.NewMemDatabase()))
...
// See https://github.com/vntchain/go-vnt/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(vntdb.NewMemDatabase()))
