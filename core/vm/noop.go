...
func NoopCanTransfer(db inter.StateDB, from common.Address, balance *big.Int) bool {
	return true
}
func NoopTransfer(db inter.StateDB, from, to common.Address, amount *big.Int) {}
