...
// values.
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db vntdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
...
func makeHeader(chain consensus.ChainReader, parent *types.Block, state *state.StateDB, engine consensus.Engine) *types.Header {
	...
	if parent.Time() == nil {
		...
		time = new(big.Int).Add(parent.Time(), big.NewInt(2)) // block time is fixed at 10 seconds
	}
...
func makeHeaderChain(parent *types.Header, n int, engine consensus.Engine, db vntdb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, engine consensus.Engine, db vntdb.Database, seed int) []*types.Block {
