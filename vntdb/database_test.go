...
func newTestLDB() (*vntdb.LDBDatabase, func()) {
	...
	db, err := vntdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(vntdb.NewMemDatabase(), t)
}

func testPutGet(db vntdb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(vntdb.NewMemDatabase(), t)
}

func testParallelPutGet(db vntdb.Database, t *testing.T) {
	const n = 8
