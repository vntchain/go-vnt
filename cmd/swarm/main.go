...
import (
	...
	"github.com/vntchain/go-vnt/swarm"
	bzzapi "github.com/vntchain/go-vnt/swarm/api"
	swarmmetrics "github.com/vntchain/go-vnt/swarm/metrics"
...
var (
	...
	testbetBootNodes = []string{
		"vnode://ec8ae764f7cb0417bdfb009b9d0f18ab3818a3a4e8e7c67dd5f18971a93510a2e6f43cd0b69a27e439a9629457ea804104f37c85e41eed057d3faabbf7744cdf@13.74.157.139:30429",
		"vnode://c2e1fceb3bf3be19dff71eec6cccf19f2dbf7567ee017d130240c670be8594bc9163353ca55dd8df7a4f161dd94b36d0615c17418b5a3cdcbb4e9d99dfa4de37@13.74.157.139:30430",
		"vnode://fe29b82319b734ce1ec68b84657d57145fee237387e63273989d354486731e59f78858e452ef800a020559da22dcca759536e6aa5517c53930d29ce0b1029286@13.74.157.139:30431",
		"vnode://1d7187e7bde45cf0bee489ce9852dd6d1a0d9aa67a33a6b8e6db8a4fbc6fcfa6f0f1a5419343671521b863b187d1c73bad3603bae66421d157ffef357669ddb8@13.74.157.139:30432",
		"vnode://0e4cba800f7b1ee73673afa6a4acead4018f0149d2e3216be3f133318fd165b324cd71b81fbe1e80deac8dbf56e57a49db7be67f8b9bc81bd2b7ee496434fb5d@13.74.157.139:30433",
	}
)
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:   "swap-api",
		Usage:  "URL of the VNT API provider to use to settle SWAP payments",
...
// This init function sets defaults so cmd/swarm can run alongside gvnt.
func init() {
...
var app = utils.NewApp(gitCommit, "VNT Swarm")
...
func bzzd(ctx *cli.Context) error {
	...
	//gvnt only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for gvnt and swarm
...
func registerBzzService(bzzconfig *bzzapi.Config, ctx *cli.Context, stack *node.Node) {
	...
	boot := func(ctx *node.ServiceContext) (node.Service, error) {
		var swapClient *vntclient.Client
		var err error
		if bzzconfig.SwapApi != "" {
			log.Info("connecting to SWAP API", "url", bzzconfig.SwapApi)
			swapClient, err = vntclient.Dial(bzzconfig.SwapApi)
			if err != nil {
...
func injectBootnodes(srv *vntp2p.Server, nodes []string) {

	for _, url := range nodes {
		n, err := vntp2p.ParseNode(url)
		if err != nil {
